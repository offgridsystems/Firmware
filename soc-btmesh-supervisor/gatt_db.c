...
0xe8, 0xf5, 0xc6, 0x04, 0x57, 0xb9, 0x25, 0xab, 0x0b, 0x4f, 0x7e, 0xed, 0x67, 0x0e, 0x42, 0x97, 
0x6e, 0xf1, 0x33, 0x58, 0xe9, 0x25, 0xa5, 0xa3, 0x70, 0x4c, 0x79, 0xe0, 0x7f, 0x64, 0x9a, 0x9b, 
};




struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_29_data = {
	.len=1,
...
GATT_DATA(const struct bg_gattdb_attribute_chrvalue	bg_gattdb_data_attribute_field_29 ) = {
	...
	.index=7,
	.max_len=5,
	.data_varlen=&bg_gattdb_data_attribute_field_29_data,
};

GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_28 ) = {
	.len=19,
	.data={0x2a,0x1e,0x00,0x6e,0xf1,0x33,0x58,0xe9,0x25,0xa5,0xa3,0x70,0x4c,0x79,0xe0,0x7f,0x64,0x9a,0x9b,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=16,
	.data={0xe8,0xf5,0xc6,0x04,0x57,0xb9,0x25,0xab,0x0b,0x4f,0x7e,0xed,0x67,0x0e,0x42,0x97,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8003,.permissions=0x803,.caps=0x03,.datatype=0x02,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_29},
    {.uuid=0x0010,.permissions=0x807,.caps=0x03,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x02,.index=0x07,.clientconfig_index=0x03}},
};
