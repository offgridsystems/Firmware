...
bool initDcClient(Nrf24DcClient &client) 
{
    ...
    client.driver.setRetries(2, 15);         // set 15 retries and 500uSec between retransmition in autoACK mode.
    ...
    client.driver.setDataRate(RF24_250KBPS);   // the communication speed (RF24_250KBPS, RF24_1MBPS, RF24_2MBPS)
    ...
    client.setDeviceId(55);                // unique in same network ID
