 ...
 * bg_compat.h
 *
 * Compatibility macros for bgcommon
 *
 *  Created on: 9.4.2015
 *      Author: jeknaapp
 */
...
#define BG_ATOMIC_BIT_SET(bitmask, bit) BUS_RamBitWrite(bitmask, bit, 1)

#define BG_ATOMIC_BIT_CLR(bitmask, bit) BUS_RamBitWrite(bitmask, bit, 0)
